...
import { cityColumns, displayNameShort, slugFromUrl } from "./sql-fragments.js";
...
export async function getTopCities(limit = 30): Promise<QueryResult<CityTopRow>> {
	return query<CityTopRow>(
		...
		group by e.city_id, c.name_ru, c.name_en, c.slug, c.url, c.image_cover, c.country_id, country.name_ru, country.name_en, country.url
